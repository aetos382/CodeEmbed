...
msbuild.exe transform.proj /p:Source=CodeEmbed.Web.Api\CodeEmbed.Web.Site.csproj /p:Transform=CodeEmbed.Web.Api\CodeEmbed.Web.Site.csproj.transform /logger:"%logger%"
