namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class UserPlanExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IUserPlan>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetUserPlan(client, uri, null, null, CancellationToken.None);
