namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GistExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGist>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGist(client, uri, null, null, CancellationToken.None);
