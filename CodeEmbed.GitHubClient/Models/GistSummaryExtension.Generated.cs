namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GistSummaryExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGistSummary>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGistSummary(client, uri, null, null, CancellationToken.None);
