namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GistFileContentExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGistFileContent>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGistFileContent(client, uri, null, null, CancellationToken.None);
