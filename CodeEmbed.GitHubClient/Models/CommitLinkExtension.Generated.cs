namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class CommitLinkExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<ICommitLink>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetCommitLink(client, uri, null, null, CancellationToken.None);
