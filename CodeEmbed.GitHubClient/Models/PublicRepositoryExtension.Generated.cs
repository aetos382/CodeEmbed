namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class PublicRepositoryExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IPublicRepository>(uri, encoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetPublicRepository(client, uri, null, CancellationToken.None);
