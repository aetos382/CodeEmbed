namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class RepositoryUserExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IRepositoryUser>(uri, encoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetRepositoryUser(client, uri, null, CancellationToken.None);
