namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GistFileExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGistFile>(uri, encoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGistFile(client, uri, null, CancellationToken.None);
