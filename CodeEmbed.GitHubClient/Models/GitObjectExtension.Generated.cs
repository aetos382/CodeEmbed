namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GitObjectExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGitObject>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGitObject(client, uri, null, null, CancellationToken.None);
