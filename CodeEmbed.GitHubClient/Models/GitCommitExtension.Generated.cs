namespace CodeEmbed.GitHubClient.Models
{
    ...
    public static partial class GitCommitExtension
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await client.GetData<IGitCommit>(uri, requestHeaders, responseEncoding, cancellationToken).ConfigureAwait(false);
            ...
            Uri uri)
        {
            ...
            var result = GetGitCommit(client, uri, null, null, CancellationToken.None);
