    ...
    public class PublicRepositoryTests
    {
        ...
        public async Task PublicRepositoryDeserializationTest()
        {
            ...
            using (var reader = new StreamReader(file))
            {
                ...
                serializer.MapType<IPublicRepository, SerializablePublicRepository>();
                serializer.MapType<IRepositoryUser, SerializableRepositoryUser>();

                var repository = await serializer.Deserialize<IPublicRepository>(reader, CancellationToken.None);
